...
$(function () {
    ...
    function renderpointpenilaian(data) {
        ...
        var html = '';
        for (var i in data) {
            html = html + '<table style="width:100%;"><tr><td style="min-width:85%"><input type="text" class="form-control cekpoint" style="margin-bottom:7px;" value="' + data[i].LocalizedName + '" disabled/>';
            ...
            html = html + '</td><td style="min-width:10%"><input type="text" class="form-control perc" style="margin-bottom:7px;" disabled/></td>';
    ...
    function rendervalue(data) {
        ...
        if (userid == userlogin) {
            ...
            for (var i in data) {
                ...
                html = html + '<div class="col-md-1" style="margin-bottom:5px;">';
    ...
    function renderquestion(data) {
        ...
        for (var i in data) {
            ...
            html = html + '<input type="text" class="form-control text-center" value="%" disabled>';
            html = html + '</div>';
    ...
    function renderdata(data) {
        ...
        html = html + '</select><span><input type="number" class="form-control bobot-nilai" value="0" max="100" min="0" style="max-width: 10%;"></span>';
        html = html + '<span><input type="text" class="form-control percentage" value="%" style="max-width: 5%;" disabled="disabled"></span>';
