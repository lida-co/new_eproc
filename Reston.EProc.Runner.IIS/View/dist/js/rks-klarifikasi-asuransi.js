...
function generateTable(pengadaanId) {
    $.ajax({
        ...
        url: 'Api/PengadaanE/getRKSKlarifikasiAsuransi?PId=' + pengadaanId,
        dataType: 'json',
...
$(function () {
    ...
    $("body").on("click", "#CetakWord", function () {
        downloadFileUsingForm("/api/report/CetakRKSKlarfikasiAsuransi?Id=" + $("#pengadaanId").val());
    });

    $("body").on("click", "#CetakXls", function () {
        downloadFileUsingForm("/api/report/CetakRKSKlarfikasiAsuransiXls?Id=" + $("#pengadaanId").val());
    });
