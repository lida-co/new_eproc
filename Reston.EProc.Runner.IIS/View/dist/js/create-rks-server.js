...
$(function () {
    ...
    $(".refresh").on("click", function () {
        window.location.href = "https://" + window.location.host + "/create-rks.html#" + $("#rksId").val();
    ...
    $("#kembali").on("click", function () {
        window.location.replace("https://" + window.location.host + "/repository-rks.html");
    });
});
...
function addNewData(baris, newdata) {
	console.log('woy', baris, newdata, table.row(baris), table.row(baris).data());
