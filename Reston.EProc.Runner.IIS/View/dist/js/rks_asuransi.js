...
$(function () {
    ...
    $("body").on("click", "#CetakWord", function () {
        downloadFileUsingForm("/api/report/CetakHPSAsuransi?Id=" + $("#pengadaanId").val() + "&DocumentIdBaru=" + $("#documentidasuransi").val());
    });

    $("body").on("click", "#CetakXls", function () {
        downloadFileUsingForm("/api/report/CetakHPSXLSAsuransi?Id=" + $("#pengadaanId").val() + "&DocumentIdBaru=" + $("#documentidasuransi").val());
    });
    $("#myNav").affix({
        offset: {
            top: 100
  ...
  /*  $(".load-get-rks").on("click", function () {
    ...
    */
    ...
    //$(".save-rks-template").on("click", function () {
    //    $("#modal-save-to-template").modal("show");
    ...
    $("#simpanalasuransi").on("click", function () {
        $("#modal-simpan-ulul").show();
    });
...
$(function () {
    ...
    $(".save-repo-rks").on("click", function () {
        var objRKSHeader = {};
        if ($("#idrepoRks").val() != "") objRKSHeader.Id = parseInt($("#idrepoRks").val());
