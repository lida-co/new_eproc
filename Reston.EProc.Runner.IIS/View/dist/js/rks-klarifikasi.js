...
function generateTable(pengadaanId) {
    $.ajax({
        ...
        success: function (data) {
            ...
            // fixed headers
            ["", "Nama", "Item", "Satuan", "Jumlah", "HPS"].forEach(text => {
            ...
            data.hps.forEach((hpsItem, i) => {
                ...
                data.vendors.forEach(vendor => {
                    ...
                    if (i < totItemInVendor && hpsItem.harga > 0 && vendor.items[i].harga > 0) {
                        tdVendorHarga.textContent = accounting.formatNumber(vendor.items[i].harga, {
                            thousand: ".", decimal: ",", precision: 2
                        });
                    }
