...
$(function () {
    ...
    $(".box-folder-vendor").on("click", function () {
        window.location.replace(HOME_PAGE + "/rekanan-detail.html");
    });
    ...
    $("#edit").on("click", function () {
        ...
        safeRedirect("pengadaan_add_terbuka", "#", pengadaanId);
    ...
    $("#lanjut-tolak").on("click", function () {
        ...
        waitingDialog.showloading("Proses Harap Tunggu");
        var objData = {};
        objData.PenolakanId=DOMPurify.sanitize($("#pengadaanId").val());
...
function loadData(pengadaanId) {
    $.ajax({
        ...
        //    window.open(HOME_PAGE + "/rks.html#" + $("#pengadaanId").val());
        //}); 
    });
}
